...
class AppDecoration {
  static BoxDecoration get outlineBluegray2001e1 => BoxDecoration(
  ...
  static BoxDecoration get outlineBluegray2001e => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
  ...
  static BoxDecoration get fillWhiteA70090 => BoxDecoration(
  ...
  static BoxDecoration get outlineBluegray20023 => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
  ...
  static BoxDecoration get fillGray800ab => BoxDecoration(
        color: ColorConstant.gray800Ab,
      );
  ...
  static BoxDecoration get outlineBluegray20028 => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
