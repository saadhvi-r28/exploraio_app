                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                            ...
                                                                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                              Text("VIT Chennai".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplaySemibold16.copyWith(height: 1.00)),
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                            padding: getPadding(
                                                                                ...
                                                                                bottom: 18),
                                                                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                              Text("Vandalur Zoo".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplaySemibold16.copyWith(height: 1.00)),
                                                                              Padding(padding: getPadding(top: 6, right: 10), child: Text("lbl_2_09_mi".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplayRegular14WhiteA700.copyWith(height: 1.00)))
                                                                            ]))
                                                                      ]))),
                                                          Align(
                                                                      ...
                                                                      Align(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                ...
                                                                                Text("Chennai, Tamil Nadu".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplayRegular13WhiteA700.copyWith(letterSpacing: 0.30, height: 1.00))
                                                                              ]))),
                                                                      Padding(
                                                                          padding: getPadding(
                                                                              top:
