                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              Text("Vandaloor Zoo".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplayMedium24.copyWith(letterSpacing: 0.50, height: 1.00)),
                                                                              Padding(padding: getPadding(top: 4, right: 10), child: Text("Chennai, India".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUIDisplayRegular15Bluegray400.copyWith(letterSpacing: 0.30, height: 1.00)))
                                                                            ])),
                                                                    Padding(
                                                                        padding: getPadding(
                                                                            top:
